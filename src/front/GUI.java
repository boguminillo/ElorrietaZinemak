...
public class GUI {
	...
	private void initialize() {
		...
		tableEdukiaFilmak.setModel(new DefaultTableModel(
			new Object[][] {
			},
			new String[] {
				"Genero", "PEGI", "Iraupena", "Izenburua", "ID"
			}
		) {
			Class[] columnTypes = new Class[] {
				Object.class, Integer.class, Integer.class, String.class, Integer.class
			};
		...
		tableEdukiaFilmLaburrak.setModel(new DefaultTableModel(
			new Object[][] {
			},
			new String[] {
				"Fabula", "Iraupena", "Izenburua", "ID"
			}
		) {
			Class[] columnTypes = new Class[] {
		...
		tableEdukiaDokumentalak.setModel(new DefaultTableModel(
			new Object[][] {
			},
			new String[] {
				"Tema", "Iraupena", "Izenburua", "ID"
			}
		) {
			Class[] columnTypes = new Class[] {
